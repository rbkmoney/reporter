...
-- additional unused party_shop_id=test_shop_2 -> must be filtered
-- additional cancelled status with same payout_id on paid status (id=5*)
-- additional cancelled without status same payout_id on paid status (id=7*) -> must be filtered
...
values (1013, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 1014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_1',
        '1', '2017-08-28 06:00:01', 'paid', 1900, 'RUB', 'bank_account',
        '{
          "cash_flows": [
            {
              "source": {
       ...
       (1113, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 1014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_2',
       ...
       (11113, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 1014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_1',
        '1', '2017-08-28 06:00:01', 'cancelled', 950, 'RUB', 'bank_account',
        '{
          "cash_flows": [
            {
              "source": {
       ...
       (51013, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 51014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_1',
        '1', '2017-08-28 06:00:01', 'paid', 1900, 'RUB', 'bank_account',
        '{
          "cash_flows": [
       ...
       (51113, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 51014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_2',
        '1', '2017-08-28 06:00:01', 'paid', 950, 'RUB', 'bank_account',
        '{
          "cash_flows": [
       ...
       (511113, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 51014, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_1',
        '1', '2017-08-28 06:00:01', 'cancelled', 950, 'RUB', 'bank_account',
        '{
          "cash_flows": [
       ...
       (7511113, '2017-08-28 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 751014,
       ...
       (1118, '2017-09-27 13:06:46', 'PAYOUT_STATUS_CHANGED', 'PAYOUT', 1019, 'db79ad6c-a507-43ed-9ecf-3bbd88475b32',
        'test_shop_1',
        '1', '2017-09-27 06:00:01', 'unpaid', 300, 'RUB', 'bank_account',
        '{
          "cash_flows": [
