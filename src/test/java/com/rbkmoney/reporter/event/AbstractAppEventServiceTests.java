...
import com.rbkmoney.reporter.handler.payout.PayoutCreatedChangeEventHandler;
...
@ComponentScan(
        basePackages = {
                ...
                "com.rbkmoney.reporter.batch.manager"
        },
        excludeFilters = {
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = PartyManagementService.class),
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = ReportNewProtoServiceImpl.class),
                ...
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = ReportService.class),
