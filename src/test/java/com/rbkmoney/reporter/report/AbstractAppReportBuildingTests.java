...
@ContextConfiguration(classes = ReporterApplication.class, initializers = AbstractAppReportBuildingTests.Initializer.class)
...
public abstract class AbstractAppReportBuildingTests extends AbstractTestUtils {
    ...
    private static Consumer<EnvironmentProperties> getEnvironmentPropertiesConsumer() {
        return environmentProperties -> {
            ...
            environmentProperties.put("jobs.report.enabled", "true");
            environmentProperties.put("scheduled.initialDelay", "1500");
        };
    }
}
