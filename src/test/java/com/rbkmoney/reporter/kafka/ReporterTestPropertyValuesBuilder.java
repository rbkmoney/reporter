...
public class ReporterTestPropertyValuesBuilder {
    ...
    public static String[] build(TestContainers testContainers) {
        ...
        strings.add("kafka.processing.payment.enabled=true");
        strings.add("kafka.ssl.enabled=false");
    ...
    private static void withUsingTestContainers(TestContainers testContainers, List<String> strings) {
        ...
        testContainers.getKafkaTestContainer().ifPresent(
                c -> {
                    strings.add("kafka.bootstrap.servers=" + c.getBootstrapServers());
                    strings.add("kafka.processing.payment.topic=payment");
                }
        );
    }
    ...
    private static void withoutUsingTestContainers(List<String> strings) {
        ...
        strings.add("kafka.bootstrap.servers=localhost:" + KAFKA_PORT);
    }
}
