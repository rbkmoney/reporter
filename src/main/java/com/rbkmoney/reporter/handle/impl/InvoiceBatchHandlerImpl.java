...
public class InvoiceBatchHandlerImpl<R, C> implements InvoiceBatchHandler<R, C> {
    ...
    public List<Query> handle(
            ...
            Function<R, MapperResult> mapperResultBuilder,
            Map<InvoiceUniqueBatchKey, R> producerCache,
            Map<InvoiceUniqueBatchKey, C> consumerCache
    ) {
            Map.Entry<InvoiceBatchService, Map<InvoiceUniqueBatchKey, List<MapperPayload>>> mapperPayloadsByUniqueKeyEntry =
...
//                    .map(entry -> getEntryMap(entry, consumerCache))
...
//        }
    ...
    private Map.Entry<InvoiceUniqueBatchKey, List<R>> getEntryMap(Map.Entry<InvoiceUniqueBatchKey, List<MapperPayload>> entry,
                                                                  Map<InvoiceUniqueBatchKey, C> consumerCache) {
