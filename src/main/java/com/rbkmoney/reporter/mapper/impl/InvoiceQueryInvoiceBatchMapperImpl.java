...
public class InvoiceQueryInvoiceBatchMapperImpl implements InvoiceBatchMapper<PartyData, Void> {
    ...
    @Override
    public List<Query> map(InvoiceChangeMapper mapper, MapperPayload payload, Map<InvoiceUniqueBatchKey, PartyData> producerCache, Map<InvoiceUniqueBatchKey, Void> consumerCache) {
    ...
    private void fillCacheFromInvoice(Invoice invoice, Map<InvoiceUniqueBatchKey, PartyData> producerCache) {
