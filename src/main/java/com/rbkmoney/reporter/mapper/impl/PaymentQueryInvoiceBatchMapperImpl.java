...
public class PaymentQueryInvoiceBatchMapperImpl implements InvoiceBatchMapper<PaymentPartyData, PartyData> {
    ...
    @Override
    public List<Query> map(InvoiceChangeMapper mapper, MapperPayload payload, Map<InvoiceUniqueBatchKey, PaymentPartyData> producerCache, Map<InvoiceUniqueBatchKey, PartyData> consumerCache) {
    ...
    private void fillCacheFromPayment(Payment payment, PaymentCost paymentCost, Map<InvoiceUniqueBatchKey, PaymentPartyData> producerCache) {
    ...
    private Payment getPayment(MapperResult mapperResult, PaymentCost paymentCost, Map<InvoiceUniqueBatchKey, PartyData> consumerCache) {
        Payment payment = mapperResult.getPayment();
    ...
    private void fillPaymentFromCache(Payment payment, InvoiceUniqueBatchKeyImpl uniqueBatchKey, Map<InvoiceUniqueBatchKey, PartyData> consumerCache) {
