...
public class AdjustmentQueryInvoiceBatchMapperImpl implements InvoiceBatchMapper<Void, PaymentPartyData> {
    ...
    private void fillAdjustmentFromCache(Adjustment adjustment, PaymentInvoiceUniqueBatchKey uniqueBatchKey, Map<UniqueBatchKey, PaymentPartyData> consumerCache) {
