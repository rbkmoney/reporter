...
(
    id                          BIGSERIAL           NOT NULL,
    ext_allocation_payment_id   BIGINT              NOT NULL,
    ...
    FOREIGN KEY (ext_allocation_payment_id) REFERENCES rpt.allocation_payment (id)
);
CREATE UNIQUE INDEX IF NOT EXISTS allocation_payment_details_allocation_payment_id_idx
ON rpt.allocation_payment_details (ext_allocation_payment_id);
...
(
    id                          BIGSERIAL           NOT NULL,
    ext_allocation_refund_id    BIGINT              NOT NULL,
    fee_party_id                CHARACTER VARYING,
    fee_shop_id                 CHARACTER VARYING,
    total_amount                BIGINT,
    total_currency_code         CHARACTER VARYING,
    ...
    FOREIGN KEY (ext_allocation_refund_id) REFERENCES rpt.allocation_refund (id)
    );
CREATE UNIQUE INDEX IF NOT EXISTS allocation_refund_details_allocation_refund_id_idx
ON rpt.allocation_refund_details (ext_allocation_refund_id);
